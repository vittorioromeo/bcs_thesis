% web
% \documentclass[oneside, 12pt, a4paper, openright]{book}
% \usepackage[top=3cm, left=3cm, bottom=4cm, right=3cm]{geometry}

% print
\documentclass[twoside, 12pt, a4paper, openany]{book}
...
% \BeforeBeginEnvironment{minted}{\singlespacing\begin{tcolorbox}[arc=0mm, colback=codebg]}%
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{noexcept}
...
provided
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{virtual}
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{game_object}
entity type will be the base class from which all other game objects
derive - the interface has to be defined there:

\begin{minted}[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{cpp}
class game_object
{
public:
    virtual ~game_object() { }
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{physics_body}:
...
inherit from
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{npc}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{warrior}
class twice in
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{sword_bow_warrior}
is using C++'s
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{virtual}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{sword_warrior}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{bow_warrior}
override the same method in
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{warrior}
and causes \textbf{duplication} of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{warrior}'s
fields in
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{sword_bow_warrior}.
...
will be called
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{widget}.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{animated_widget}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{textbox}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{button}
...
\item
  ...
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{static_widget}
  and
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{animated_widget}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{widget}'s
...
\item
  ...
  \item
    \emph{Example:} a
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{tank}
    entity may be ``composed'' by a
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{cannon}
    entity and a
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{tracks}
    entity.
  \end{itemize}
\end{itemize}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{public}
fields.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{on_destruction}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{tk}
needs to outlive both
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{cn}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ts})}.
...
\textbf{tagged}
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{union}
of lightweight structs, by using run-time polymorphism, or by using a
variant type like
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::variant}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{message_queue}
object:
...
\item
  ...
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{behavior}
  class.
\item
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{skeleton}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{dragon}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{entity}
provides an interface to manipulate behaviors at run-time, and stores
the behaviors in a
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::vector}
of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::unique_ptr<behavior>},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{clickable}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{behavior}
type will provide a
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{virtual handle_message(const message&)}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{bool context::has_component<...>(entity_id)}.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{auto& context::get_component<...>(entity_id)}.
...
The role of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{entity metadata}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{component storage}
...
matching entities\footnote{in a real implementation, systems will
  ...
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{context}
  will not have to continuously iterate over all existing entities.},
with an interface like
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{void context::for_entities_with<...>(f)}.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{example_system}
could be parallelized by splitting the range provided by
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{for_entities_with}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{component_storage},
...
of an
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{animation}
...
allowing
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{velocity}
to communicate with
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{acceleration}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{position}
to communicate with
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{velocity}:
...
\emph{(plain-old-data)}
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{struct}
types.
...
wrapper
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{constexpr}
...
cumbersome
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{.template}
disambiguation syntax)} and implementation code.

Component tags are defined using
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::tag::component::v}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::tag::system::v}:
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{make_csl()}
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{make_ssl()}
...
provided by
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{context_settings}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::velocity}
system declared in
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{struct}
contains a
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{process}
template method that takes a single
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{TData& data}
\emph{lvalue reference} as its argument \emph{(note that
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{process}
is not a special method that is specifically recognized by ECST)}.
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{data}
is a \textbf{data proxy} object, which abstracts the operations of a
system behind a \textbf{safe and transparent} interface.

By invoking the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{data.for_entities}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{c::position}
component through a mutable reference, and the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{c::velocity}
component through a
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{const}
...
\item
  ...
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::velocity::process}:
...
\item
  ...
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{main_storage}.
\item
  The element managing systems, threads, and scheduling is called the
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{system_manager}.
\end{itemize}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{metadata}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{chunk}
...
\item
  A
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{thread_pool}
  instance, used to efficiently execute system logic in separate
  threads.
\item
  A
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{system_storage},
  which stores an
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{instance}
...
\item
  A
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{state_manager},
  containing
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{state}
  instances.
...
\item
  ...
  instance.
\item
  A \emph{dense bitset}\footnote{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::bitset}.}
...
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1basic__tuple.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::basic_tuple}}
instances containing the user-specified signature types wrapped in
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1type.html\#ae35139e732c4b75e91061513cf445628}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::type_c}}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{instance.template method<...>(...)}
template disambiguation syntax\footnote{such syntax negatively impacts
  ...
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{<}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::tag}
namespace. Both component tags and system tags are implemented in the
same way: a
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{struct}
deriving from
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1type.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::type}}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{constexpr}
variable called
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{v}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::mp::unwrap}\footnote{the
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::mp}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{private}
...
Note that
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{valid}
is implemented as a
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{constexpr}
value \emph{(instance of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{impl::valid_t})}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{tag::component::is_list}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{tag::system::is_list}
...
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1map.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::map}}
instances and method chaining. Here is an example of user code that
creates a \emph{system signature} for
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::acceleration}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ss_acceleration}
...
\item
  Use the
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{split_evenly_per_core}
  \emph{inner parallelism strategy}.
\item
  Use the
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{c::acceleration}
  component (read-only).
\item
  Use the
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{c::velocity}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{.parallelism(...)}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{.read(...)}.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::mp::option_map}
...
\item
  ...
  \href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/group__group-Comparable.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{Comparable}}
  and
  \href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/group__group-Hashable.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{Hashable}}
  concepts.
  ...
  \item
    ...
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{constexpr}
    \href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1integral__constant.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::integral_constant}}
    instances, with incrementing values.
  \end{itemize}
\item
  The keys are associated with compile-time pairs of an user-defined
  type and
  \href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1integral__constant.html\#aa301b96de91d665fdc846bde4659b0d3}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::bool_c}}.
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{_map}
field is a
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1map.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::map}}
instance. The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{set}
method returns a new
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{option_map}
instance, adding
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{key -> (x, boost::hana::false_c)}
to
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{_map}.
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{add}
method returns a new
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{option_map}
instance, setting the value at
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{key}
to
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{(x, boost::hana::true_c)}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::signature::system::make(...)}
function:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{system_signature}
by calling
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{signature::system::make},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{_option_map}.
...
\item
  \textbf{SFINAE},
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::enable_if_t},
  and generic lambdas with trailing return types are used together with
  \href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/overload_8hpp.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::overload}}
...
9.1.1})}. The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{contiguous_buffer}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{context::step(...)}
...
IDs to reclaim
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{to_kill}
and a set of entity IDs to match
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{to_match}.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::bitset}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ct},
...
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1tuple.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::tuple}}.
...
\item
  ...
  \begin{itemize}
  \item
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{component_tag_list_type}:
    a \emph{type list} containing all the tags of components stored.
  \item
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{metadata_type}:
...
By default, the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{contiguous_buffer},
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{empty}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{hash_map}
...
\item
  ...
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::array}
  or an
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::vector},
...
\item
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{hash_map}
  stores data in an
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::unordered_map}.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{metadata}
derives from
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{TChunkMetadataTuple}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{_counter}
...
stored in either
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::entity::container::dynamic}
or
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::entity::container::fixed},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::tuple},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ecst::fixed_function},
similar to
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::function}
but with a fixed allocation size. Synchronization is implemented using
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::condition_variable}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::atomic}
counters. An implementation making use of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::packaged_task}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::future}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{moodycamel::BlockingConcurrentQueue},
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{_queue->wait_dequeue(t)}
method call will block the current thread until the queue is not empty,
and then dequeue a task into
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{t}.
...
alongside an
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::mutex}
in a data structure called
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{counter_blocker}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{spawn_tasks}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{access_cv_counter},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::unique_lock}
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::s0}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::s1}
system types need to be independent of each other \emph{(a compile-time
error will occur otherwise)}. After calling
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{proxy.execute_systems_from},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{atomic_counter}
- it
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{counter_blocker}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{atomic_counter::start_execution}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{atomic_counter::task::run}
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{instance::prepare_and_wait_n_subtasks}
...
The implementation of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{make_bound_slice_executor}
...
\section{Data proxies}\label{data-proxies}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{fs_refresh...}
...
\emph{step}, using the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{.detailed}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{.for_subtasks}
method interface.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{impl::enable_matching_instance}
...
the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{check_tag<TInstance, TSystemTag>()}
expression evaluates to
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{false}.
Here is the implementation of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{check_tag}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{system_execution_adapter}
namespace will return SFINAE-restricted functions that will be linearly
overloaded by the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{proxy.execute_systems}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{system_execution_adapter::matching}
as a building block:

\begin{itemize}
\item
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{system_execution_adapter::all}
  returns a
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{sea::matching}
  with a \emph{tautology predicate}.
\item
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{system_execution_adapter::t(...)}
  returns a
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{sea::matching}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{invalid_id}.
Handles pointing to
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{invalid_id}
are considered \textbf{null} or \textbf{invalid} handles -
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{valid_handle}
returns
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{false}
for them.
...
implemented using
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::vector<std::function>}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::tuple}
instances. Boost.Hana provides a
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::for_each}
...
over
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{ctag_list}
and setting the corresponding component bits to
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{1}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{static_if},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{dispatch_on_storage_type}
...
\item
  ...
  \emph{(\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1integral__constant.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::integral_constant}})}.
\item
  The BFT queue is a
  \href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1tuple.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::tuple}}.
\item
...
\item
  ...
  \href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/structboost_1_1hana_1_1pair.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::pair}}.
  The pair is referred to as the \textbf{BFT context}.
\end{itemize}

All operations are defined inside the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{bf_traversal}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{bf_traversal::execute}
function, which takes a list of starting nodes and the complete system
signature list as parameters. A
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{step}
...
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/group__group-functional.html\#ga1393f40da2e8da6e0c12fce953e56a6c}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::fix}},
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{bf_traversal::step_forward}
function:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{dependent_ids_list},
...
\href{http://www.boost.org/doc/libs/1_61_0/libs/hana/doc/html/fold__right_8hpp.html}{\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{boost::hana::fold_right}})},
...
of the
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{atomic_counter::execute}
scheduler function}, under the name
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{chain_size},
...
\item
  \textbf{Position}: 2D
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{float}
  vector.
...
\item
  ...
  \item
    Produces
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::vector<sp_data>}
    outputs.
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{sp_data}
    is a lightweight
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{struct}
    holding an
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{entity_id}
...
\item
  ...
  \item
    Produces
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::vector<contact>}
    outputs.
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{contact}
    is a lightweight
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{struct}
    holding
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{entity_id}
    ...
    from the
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{solve_contacts}
    system to solve penetration between particles.
  \end{itemize}
\item
  \textbf{Solve contacts}: reads
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{collision}'s
  produced
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{contact}
...
\item
  ...
  \item
    Produces
    \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::vector<sf::Vertex>}
...
\item
  ...
  every particle's
  \mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{life}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::fade},
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::life}
and
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::keep_in_bounds}
are implemented in a similar way.

\subsubsection{Spatial partition}\label{spatial-partition}

\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::spatial_parititon}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::array}
of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{std::vector<entity_id>}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{_grid}
is cleared. The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{process}
...
Every subtask of
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::spatial_partition}
will produce
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{sp_data}
...
The
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::collision}
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::solve_contacts}
system.
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{s::collision::process}:
...
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{g++}
version 6.1.1 was used, with the following compiler flags:\\
\mintinline[frame=lines, bgcolor=codebg, framesep=1mm, numbersep=12pt, fontsize=\footnotesize, xleftmargin=17pt, linenos, mathescape]{text}{-Ofast -march=native -ffast-math -ftree-vectorize}.
